    ...
    <>
      <section className="my-5">
        <div className="container-fluid" data-aos="slide-up" data-aos-duration="1000">
          <h2 align="center" className="display-5 my-4">Database Testing and Standard for Renewable Energy</h2>
          <div className="row row-cols-1 row-cols-md-3 g-4">
            <div className="col" data-aos="slide-up" data-aos-duration="1000" data-aos-delay="100">
              <div className="card h-100 shadow-sm">
                <img src={process.env.PUBLIC_URL + "/File/image/brin2.png"} alt="About us" className="card-img-top" />
            ...
            <div className="col" data-aos="slide-up" data-aos-duration="1000" data-aos-delay="500">
              <div className="card h-100 shadow-sm">
                <img src={process.env.PUBLIC_URL + "/File/image/tiang.jpg"} alt="Our Goals" className="card-img-top" />
                <div className="card-body">
            ...
            <div className="col" data-aos="slide-up" data-aos-duration="1000" data-aos-delay="900">
              <div className="card h-100 shadow-sm">
                <img src={process.env.PUBLIC_URL + "/File/image/prtps.png"} alt="Contact us" className="card-img-top" />
                <div className="card-body">
      ...
      <section className="container-fluid">
        <div className="row my-4 rounded-4 p-3">
          <div className="col-lg-6" data-aos="slide-right" data-aos-duration="1000" data-aos-delay="200">
            <img src={process.env.PUBLIC_URL + "/File/image/panel.jpg"} alt="Standard and Testing" className="img my-auto h-auto w-100 rounded-4 mb-3" />
          </div>
          <div className="col-lg-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            <div className="d-flex align-items-center justify-content-center h-100">
              <div>
                ...
                <p>
                  Hence various testing are required to fulfill these standards. These tests ensure that
                  products or services meet specified requirements and function correctly, helping to
                  maintain high quality. Tests also identify defects or issues before a product reaches the
        ...
        <div className="row my-4 rounded-4 p-3">
          <div className="col-lg-6 d-lg-none d-block" data-aos="slide-left" data-aos-duration="1000" data-aos-delay="200">
            <img src={process.env.PUBLIC_URL + "/File/image/hydropower.jpg"} alt="Regulation and Research" className="img my-auto h-auto w-100 rounded-4 mb-3" />
          </div>
          <div className="col-lg-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
            <div className="d-flex align-items-center justify-content-center h-100">
              <div>
                ...
                <p>
                  ...
                  renewable technologies in Indonesia.
                </p>
                <p>
